  ...
  return (
    <>
      ...
      <div style={{
        ...
        padding: '20px',
        paddingBottom: showPlayer ? '100px' : '20px',
        maxWidth: '500px',
        margin: '0 auto'
      }}>
        {/* Header */}
        <div style={{ textAlign: 'center', marginBottom: '16px' }}>
          ...
          <p style={{ color: '#888', margin: 0, fontSize: '14px' }}>February 2026</p>
        </div>
        ...
        {view === 'calendar' && (
          <div style={{
            ...
            <div style={{
              ...
              {/* Feb 1, 2026 is Sunday - 0 empty cells */}
      ...
      {showPlayer && (
        <div style={{
          ...
          <iframe
            width="60"
            height="60"
            src="https://www.youtube.com/embed/90Fpjwctqlw?autoplay=1&loop=1&playlist=90Fpjwctqlw"
          ...
          />
          <div style={{ flex: 1 }}>
            <p style={{ margin: 0, fontSize: '14px', fontWeight: '600', color: '#fff' }}>Where Is My Mind</p>
            <p style={{ margin: 0, fontSize: '12px', color: '#888' }}>Pixies</p>
          </div>
          <button
