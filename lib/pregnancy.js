...
export const pregnancyWeeks = {
  ...
  15: {
    ...
    support: [
      ...
      "Keep exercising together—walks, swimming, or yoga"
    ]
  },
  16: {
    ...
    support: [
      ...
      "Read or sing to the baby—they can hear you now"
    ]
  },
  17: {
  ...
  18: {
    ...
    support: [
      "Attend the anatomy scan together—this is a big one",
      "Help her elevate her feet when they're swollen",
      "Start thinking about a birth plan together",
      "Capture this milestone—journal or photos"
    ]
  },
  19: {
  ...
  20: {
    ...
    support: [
      "Celebrate this huge milestone—you're halfway!",
      "Talk to the baby regularly—your voice is becoming familiar",
...
export const pregnancyMilestones = [
  {
    week: 6, label: "First heartbeat detectable", emoji: "💓",
    description: "An ultrasound can pick up a tiny flickering heartbeat — 100 to 160 beats per minute. The embryo is only about 4mm, but that heartbeat changes everything.",
  ...
  {
    week: 8, label: "First prenatal visit", emoji: "🏥",
    ...
    couple: "Go together. Write down questions beforehand — you'll both forget in the moment. This visit sets the tone for how involved you are. She'll notice, and it matters."
  },
  {
    week: 10, label: "NIPT / genetic screening window", emoji: "🧬",
    ...
    couple: "Have an honest conversation beforehand about what you want to learn. There's no right answer — just make sure you're on the same page. This is a moment to lean into each other."
  },
  {
    week: 12, label: "End of first trimester", emoji: "🎉",
    ...
    couple: "This is a huge exhale for both of you. It's also a good time to celebrate privately — you've made it through the hardest stretch of early pregnancy together."
  },
  {
    week: 13, label: "Second trimester begins", emoji: "✨",
  ...
  {
    week: 16, label: "Baby can hear your voice", emoji: "👂",
    description: "The baby's ears are developed enough to hear sounds — your voice, her heartbeat, music. Studies show babies recognize voices they heard in the womb.",
  ...
  {
    week: 18, label: "Anatomy scan (18-22w)", emoji: "📷",
    description: "The detailed anatomy scan checks brain, heart, spine, kidneys, and limbs. This is the 'big ultrasound' — usually 30 to 45 minutes. Many couples learn the sex here.",
    couple: "This is the appointment most couples say feels like meeting their baby. You'll see fingers, toes, a face. Be present, ask questions, take the printout home — first family photo."
  },
  {
